...
INSTALLED_APPS = [
    'cloudinary_storage', # Cloudinary must be before django.contrib.staticfiles
    'cloudinary',
...
CORS_ALLOWED_ORIGINS = [
    "https://campus-market-psi.vercel.app",
    "http://localhost:5173",
]
...
# This single block replaces the conflicting ones you had before
STORAGES = {
    "default": {
